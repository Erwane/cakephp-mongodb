...
class ResultSetFactory
{
    ...
    protected bool $_enforceSchema = false;

    /**
     * Create a resultset instance.
     *
     * @param iterable $results Results.
     * @param \CakeMongo\ODM\Query\SelectQuery<T>|null $query Query from where results came.
     * @return \Cake\Datasource\ResultSetInterface
     */
    public function createResultSet(iterable $results, ?SelectQuery $query = null): ResultSetInterface
    {
        if ($query) {
            $this->_enforceSchema = $query->getRepository()->hasForcedSchema();
     ...
     * entity hydration.
     *
     * @param \CakeMongo\ODM\Query\SelectQuery $query The query from where to derive the data.
     * @return array
     */
