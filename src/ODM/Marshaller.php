 ...
 *
 * @see \CakeMongo\ODM\Table::newEntity()
 * @see \CakeMongo\ODM\Table::newEntities()
 * @see \CakeMongo\ODM\Table::patchEntity()
 * @see \CakeMongo\ODM\Table::patchEntities()
 */
class Marshaller
{
     ...
     */
    protected RepositoryInterface $_table;

    /**
     * Constructor.
     *
     * @param \Cake\Datasource\RepositoryInterface $table The table this marshaller is for.
     */
